...
const Navbar = () => {
  ...
  {showOverlay && (
    <AddressOverlay closeOverlay={handleOverlayClose} saveAddress={saveAddress} />
      ...
      {/* Desktop View */}
      <header className="hidden md:flex items-center justify-between py-6 px-20 bg-gradient-to-b from-[#FF6500] to-[#000000] text-black">
        {/* Logo */}
        <div className="flex items-center mr-6">
          <img src="src/assets/logo.png" alt="logo" className="h-8 mr-4" /> {/* Replace with your logo */}
          <div className="text-sm">
            ...
            <div className="flex items-center space-x-1 cursor-pointer" onClick={handleOverlayOpen}>
              <span className="text-black-300">{userAddress}</span>
              <span className="text-black">&#9660;</span> {/* Down arrow for dropdown */}
            </div>
          </div>
        </div>
